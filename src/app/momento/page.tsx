...
export default async function Momento(){
 ...
 return <AppShell><div className="moment-editorial">
  <div className="moment-editorial-toolbar"><div><span>JORNADA DE HOJE</span><p>Sua dose diária de fé</p></div><MomentTopActions id={d?.id} title={heroTitle}/></div>
  ...
  <div className="moment-editorial-actions">
   <div className="moment-editorial-action-card audio"><div className="moment-editorial-action-head"><span><Volume2 size={20}/></span><b>Ouvir</b></div><GospelAudioButton audioUrl={d?.audio_url} text={gospel}/></div>
   <a className="moment-editorial-action-card" href="#reflexao"><div className="moment-editorial-action-head"><span><Sparkles size={20}/></span><b>Refletir</b></div></a>
   <a className="moment-editorial-action-card" href="#oracao"><div className="moment-editorial-action-head"><span><Heart size={20}/></span><b>Orar</b></div></a>
  </div>
