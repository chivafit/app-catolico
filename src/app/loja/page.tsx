...
export default function Loja(){
 ...
 return <AppShell><div className={`${styles.page} ${styles.storeV2}`}>
  <div className={styles.storeHeader}><div><small>CURADORIA VINDE</small><h1>Loja</h1><p>Escolhas para acompanhar sua fé e sua casa.</p></div><Link href="/carrinho" className={styles.cartTop}><ShoppingCart size={19}/>{cartCount>0&&<b>{cartCount>99?"99+":cartCount}</b>}</Link></div>
