...
function ErrorState({title,description}:{title:string;description:string}){
 return <AppShell><div className="solidarity-detail-error"><span><AlertCircle size={22}/></span><h1>{title}</h1><p>{description}</p><Link href="/solidariedade">Voltar para Solidariedade <ArrowRight size={16}/></Link></div></AppShell>
}
