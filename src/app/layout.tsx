import "./globals.css";import "./discovery.css";import "./recommendations.css";import type {Metadata} from "next";import {AuthProvider} from "@/components/AuthProvider";import {AuthUrlHandler} from "@/components/AuthUrlHandler";
